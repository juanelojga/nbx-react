      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Card className="border-primary/20 bg-primary/5">
            <CardHeader>
              <CardTitle className="text-sm">Primary Red</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="h-20 bg-primary rounded-md"></div>
              <p className="mt-2 text-xs text-muted-foreground">#E53935</p>
            </CardContent>
          </Card>

          <Card className="border-secondary/20 bg-secondary/5">
            <CardHeader>
              <CardTitle className="text-sm">Primary Blue</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-warning/20 bg-warning/5">
            <CardHeader>
              <CardTitle className="text-sm">Accent Yellow</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="h-20 bg-warning rounded-md"></div>
              <p className="mt-2 text-xs text-muted-foreground">#FFC107</p>
            </CardContent>
          </Card>
        </div>
      </section>
